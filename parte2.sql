...
CREATE OR REPLACE P_FACTURAR IS
BEGIN
...
--MONTO EXENTO		
SELECT SUM(C.PRECIO_UNITARIO*CANTIDAD)
FROM CARGO_RESERVA CR JOIN PRODUCTO_SERVICIO PS
...
--MONTO
SELECT SUM(CR.PRECIO_UNITARIO * CR.CANTIDAD) MONTO
